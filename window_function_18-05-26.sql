...
select *, sum(salary) over(partition by department), sum(salary) over(order by department)
from employees;
...
-- Difference windows function and group by
-- difference between row_number, rank and dense
-- difference between where and having clause'
-- types of join in sql
-- natural join and cartesian(cross join)
-- what is super, pprimary, unique, foriegn
