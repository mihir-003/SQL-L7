...
having total_spending > (select avg(amount) from orders where c.customer_id = o.customer_id);


-- what is PLSQL? why we use it
-- Difference between plsql vs sql
-- advantages of plsql
-- blocks of plsql statement